...
def banner():
	bannertop = '''
	       \033[1;96m  SPAM SMS
           \033[1;96m   Edit : ERROR  INSTALL
           \033[1;93m  FB : นัท'ท ยัดหมด
              ห้ามขาย ห้ามรับยิง ของฟรี
           \033[92m  YouTube : ERROR INSTALL NH
 ----------------------------------------'''
	print(bannertop)
...
phone = input(f"\033[1;93m Phone : ")
print("")
NUM = int(input("\033[1;96m Num : "))
...
def api3():
	...
	print("\033[1;91m/// \033[1;3m\033[1;95mระบบโจมตีเบอร์ \033[1;92mที่ท่านต้องการแล้ว \033[1;91m///")
